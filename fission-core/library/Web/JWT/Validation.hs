...
import           Web.JWT.Claims.Error
import           Web.JWT.Header.Error
import           Web.JWT.Signature.Error

import           Web.JWT.Error                 as JWT
import           Web.JWT.Proof                 as JWT.Proof
