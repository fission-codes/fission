...
data Request = Request
  ...
  , _uuid        :: Text -- UUID             -- ^ The unique identifier Heroku uses for the installed add-on. It corresponds with the id field in the Heroku Platform API.
  } deriving (Show, Eq)
...
$(deriveJSON defaultOptions ''Provision)
