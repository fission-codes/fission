module Web.UCAN.Signature.Secp256k1.Types (Signature (..)) where
...
instance FromJSON Signature where
  parseJSON = withText "Secp256k1.Signature" \txt ->
    case B64.URL.decodeUnpadded $ encodeUtf8 txt of
      Right sig -> return $ Signature sig
      Left  err -> fail $ "Unable to parse Secp256k1 Signature: " <> err
